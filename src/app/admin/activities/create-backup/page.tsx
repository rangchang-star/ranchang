...
export default function AdminActivityCreateBackupPage() {
      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-[15px] font-bold text-gray-900">创建新活动（备份）</h2>
              <p className="text-[13px] text-[rgba(0,0,0,0.6)]">简化版发布活动页面，避免富文本编辑器闪退问题</p>
            </div>
          </div>
            ...
            <div className="border border-[rgba(0,0,0,0.1)]">
              ...
              <div className="p-4">
                <textarea
                  ...
                  placeholder="请输入活动描述...（简化版，不支持富文本格式）"
                ...
                />
                <p className="text-[11px] text-[rgba(0,0,0,0.5)] mt-1">备份版本使用纯文本输入，避免富文本编辑器闪退问题</p>
              </div>
            </div>
              ...
              <div className="mt-3 p-3 bg-blue-50 border border-blue-100 rounded-md">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-[12px] text-blue-700">
                    这是活动卡片在用户端显示的预览效果<br />
                    <span className="text-[11px] text-blue-600 mt-1 block">✓ 备份版本使用纯文本输入，避免富文本编辑器闪退</span>
                  </div>
                </div>
              </div>
            </div>
