...
// 中国人头像资源（使用 RandomUser.me）
const chineseAvatars = [
...
export const mockVisits = [
  {
    ...
    visitors: [
      { id: '1', name: '赵强', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: '智能制造' },
      { id: '2', name: '李华', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: '战略规划' },
      { id: '6', name: '张明', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: 'AI技术' },
    ],
    target: {
      name: '张明',
      title: '技术总监',
  ...
  },
  {
    ...
    location: '上海市浦东新区陆家嘴',
    visitors: [
      { id: '1', name: '刘伟', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: '投资' },
      { id: '2', name: '郑勇', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: '法律' },
    ],
    target: {
      name: '李华',
      title: '合伙人',
  ...
  },
  {
    ...
    location: '深圳市南山区科技园',
    visitors: [
      { id: '1', name: '王芳', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: '教育' },
      { id: '2', name: '吴敏', avatar: 'https://randomuser.me/api/portraits/women/2.jpg', skill: '人力资源' },
    ],
    target: {
      name: '王芳',
      title: '创始人',
  ...
  },
  {
    ...
    location: '杭州市西湖区',
    visitors: [
      { id: '1', name: '陈明', avatar: 'https://randomuser.me/api/portraits/women/1.jpg', skill: '金融科技' },
      { id: '2', name: '杨琳', avatar: 'https://randomuser.me/api/portraits/women/3.jpg', skill: '电商' },
    ],
    target: {
      name: '刘伟',
      title: '投资经理',
  ...
  },
  {
    ...
    location: '广州市天河区',
    visitors: [
      { id: '1', name: '陈静', avatar: 'https://randomuser.me/api/portraits/women/4.jpg', skill: '设计' },
      { id: '2', name: '孙丽', avatar: 'https://randomuser.me/api/portraits/women/5.jpg', skill: '营销' },
    ],
    target: {
      name: '陈静',
      title: '设计总监',
...
export const mockDocuments = [
  {
    id: '1',
    title: '私董会参与指南',
    description: '私董会的流程、规则和注意事项，帮助参与者快速融入私董会文化',
  ...
  },
  {
    id: '2',
    title: 'AI技术应用白皮书',
    description: '2025年AI技术在各行业的应用趋势分析，包括制造业、服务业、医疗等领域',
  ...
  },
  {
    id: '3',
    title: '企业数字化转型案例集',
    description: '10个成功的企业数字化转型案例分析，涵盖零售、制造、金融等行业',
  ...
  },
  {
    id: '4',
    title: '探访项目申请表',
    description: '申请成为探访项目的标准表格，包含企业信息、探访需求等字段',
  ...
  },
  {
    id: '5',
    title: '35+职场人转型方法论',
    description: '系统梳理35岁以上职场人的转型路径和成功经验，提供实用建议',
    fileUrl: '/documents/career-transition-methodology.pdf',
    fileType: 'pdf',
    fileSize: 6291456,
    category: '职场指南',
    createdBy: 1,
  ...
  },
  {
    id: '6',
    title: '从0到1创业实战手册',
    description: '创业全流程指南，从想法验证到产品落地，避坑指南',
    fileUrl: '/documents/startup-practical-manual.pdf',
    fileType: 'pdf',
    fileSize: 10485760,
    category: '创业指南',
    createdBy: 2,
  ...
  },
  {
    id: '7',
    title: '硬核能力评估表',
    description: '自我评估硬核能力的工具，包含12项核心能力评分体系',
    fileUrl: '/documents/hardcore-skills-assessment.xlsx',
    fileType: 'xlsx',
    fileSize: 524288,
    category: '表格模板',
    createdBy: 3,
  ...
  },
  {
    id: '8',
    title: '危机处理SOP手册',
    description: '企业危机处理的标准化流程和案例，帮助从容应对各种突发状况',
    fileUrl: '/documents/crisis-management-sop.pdf',
    fileType: 'pdf',
    fileSize: 7340032,
    category: '管理工具',
    createdBy: 1,
  ...
  },
  {
    id: '9',
    title: '团队搭建与人才招聘指南',
    description: '如何搭建高效团队，包括招聘策略、面试技巧、团队文化建设',
    fileUrl: '/documents/team-building-guide.pdf',
    fileType: 'pdf',
    fileSize: 5767168,
    category: '管理工具',
    createdBy: 2,
  ...
  },
  {
    id: '10',
    title: '商业计划书模板',
    description: '专业商业计划书模板，包含财务预测、市场分析等核心模块',
    fileUrl: '/documents/business-plan-template.pptx',
    fileType: 'pptx',
    fileSize: 4194304,
    category: '表格模板',
    createdBy: 3,
  ...
  },
  {
    id: '11',
    title: '行业人脉网络搭建策略',
    description: '系统化建立和维护行业人脉的实用方法，提升社交效率',
    fileUrl: '/documents/network-building-strategy.pdf',
    fileType: 'pdf',
    fileSize: 4194304,
    category: '职场指南',
    createdBy: 1,
  ...
  },
  {
    id: '12',
    title: '财务分析与预算管理',
    description: '企业财务管理实用指南，包括财务报表分析、预算制定与控制',
    fileUrl: '/documents/financial-analysis-guide.pdf',
    fileType: 'pdf',
    fileSize: 8388608,
    category: '管理工具',
    createdBy: 2,
  ...
  },
  {
    id: '13',
    title: 'AI工具使用速查手册',
    description: '常用AI工具清单和使用技巧，提升工作效率的必备指南',
    fileUrl: '/documents/ai-tools-quick-reference.pdf',
    fileType: 'pdf',
    fileSize: 3145728,
    category: '行业报告',
    createdBy: 3,
  ...
  },
  {
    id: '14',
    title: '用户调研方法与工具',
    description: '深度了解用户需求的调研方法论，包含问卷设计、访谈技巧',
    fileUrl: '/documents/user-research-methods.pdf',
    fileType: 'pdf',
    fileSize: 5242880,
    category: '管理工具',
    createdBy: 1,
  ...
  },
  {
    id: '15',
    title: '股权分配与激励机制',
    description: '初创企业股权分配方案和员工激励机制设计指南',
    fileUrl: '/documents/equity-distribution-guide.pdf',
    fileType: 'pdf',
    fileSize: 6291456,
    category: '创业指南',
    createdBy: 2,
  ...
  },
  {
    id: '16',
    title: '产品迭代与用户增长',
    description: '基于用户反馈的产品迭代策略，以及用户增长的有效方法',
    fileUrl: '/documents/product-iteration-growth.pdf',
    fileType: 'pdf',
    fileSize: 7340032,
    category: '管理工具',
    createdBy: 3,
  ...
  },
  {
    id: '17',
    title: '跨界合作案例分析',
    description: '多个成功的跨界合作案例，启发新的商业思路',
    fileUrl: '/documents/cross-industry-collaboration-cases.pdf',
    fileType: 'pdf',
    fileSize: 5767168,
    category: '行业报告',
    createdBy: 1,
  ...
  },
  {
    id: '18',
    title: '品牌建设与营销策略',
    description: '打造品牌影响力的系统方法论，包括定位、传播、转化',
    fileUrl: '/documents/brand-building-marketing.pdf',
    fileType: 'pdf',
    fileSize: 8388608,
    category: '管理工具',
    createdBy: 2,
  ...
  },
  {
    id: '19',
    title: '情绪管理与抗压能力提升',
    description: '35+职场人情绪管理的实用技巧，提升抗压能力和心理韧性',
    fileUrl: '/documents/emotional-management-guide.pdf',
    fileType: 'pdf',
    fileSize: 4194304,
    category: '职场指南',
    createdBy: 3,
  ...
  },
  {
    id: '20',
    title: '商业模式画布与验证',
    description: '商业模式设计与验证工具，快速测试和优化商业想法',
    fileUrl: '/documents/business-model-canvas.xlsx',
    fileType: 'xlsx',
    fileSize: 1048576,
    category: '表格模板',
    createdBy: 1,
