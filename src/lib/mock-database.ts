...
export const mockVisits = [
  {
    ...
    visitors: [
      { id: '1', name: '赵强', avatar: 'https://i.pravatar.cc/150?img=14', skill: '智能制造' },
      { id: '2', name: '李华', avatar: 'https://i.pravatar.cc/150?img=12', skill: '战略规划' },
      { id: '6', name: '张明', avatar: 'https://i.pravatar.cc/150?img=11', skill: 'AI技术' },
    ],
    target: {
      name: '张明',
      title: '技术总监',
  ...
  },
  {
    ...
    location: '上海市浦东新区陆家嘴',
    visitors: [
      { id: '1', name: '刘伟', avatar: 'https://i.pravatar.cc/150?img=13', skill: '投资' },
      { id: '2', name: '郑勇', avatar: 'https://i.pravatar.cc/150?img=14', skill: '法律' },
    ],
    target: {
      name: '李华',
      title: '合伙人',
  ...
  },
  {
    ...
    location: '深圳市南山区科技园',
    visitors: [
      { id: '1', name: '王芳', avatar: 'https://i.pravatar.cc/150?img=1', skill: '教育' },
      { id: '2', name: '吴敏', avatar: 'https://i.pravatar.cc/150?img=2', skill: '人力资源' },
    ],
    target: {
      name: '王芳',
      title: '创始人',
  ...
  },
  {
    ...
    location: '杭州市西湖区',
    visitors: [
      { id: '1', name: '陈明', avatar: 'https://i.pravatar.cc/150?img=15', skill: '金融科技' },
      { id: '2', name: '杨琳', avatar: 'https://i.pravatar.cc/150?img=3', skill: '电商' },
    ],
    target: {
      name: '刘伟',
      title: '投资经理',
  ...
  },
  {
    ...
    location: '广州市天河区',
    visitors: [
      { id: '1', name: '陈静', avatar: 'https://i.pravatar.cc/150?img=4', skill: '设计' },
      { id: '2', name: '孙丽', avatar: 'https://i.pravatar.cc/150?img=5', skill: '营销' },
    ],
    target: {
      name: '陈静',
      title: '设计总监',
